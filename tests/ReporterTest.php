...
class ReporterTest extends \PHPUnit\Framework\TestCase {
    ...
    public function testCanSetAndGetAccount() {
        ...
        $this->assertSame(1234567, $Reporter->getAccountNum());
    }
    ...
    public function testBuildJsonRequestBuildsCorrectForSalesGetVendors() {
        ...
        $Reporter
            ->setAccessToken('12345678-1234-abcd-abcd-12345678abcd')
    ...
    public function testProcessResponseReturnsCorrectArray() {
        ...
        $WorkingResponse = $this->getMockBuilder(
        ...
        $this->assertSame(
            [1234567, 9876543],
            $Reporter->processResponse($action, $WorkingResponse)
        );

        $BlankResponse = $this->getMockBuilder(
            'Psr\Http\Message\ResponseInterface'
        )->getMock();
        $BlankResponse->method('getBody')->willReturn('');

        $this->assertSame(
            [],
            $Reporter->processResponse($action, $BlankResponse)
        );
    }
    ...
    public function testPerformRequestCanCheckStatusAndReturnCorrectly() {
        ...
        $GuzzleMock = $this->getMockBuilder(
            'GuzzleHttp\ClientInterface'
        )->getMock();
        $GuzzleMock->method('request')->willReturn($Response);
        ...
        $this->assertInstanceOf('Snscripts\Result\Result', $Result);
    ...
    public function testGetSalesAccountsReturnsCorrectArray() {
        ...
        $Response
            ->method('getBody')
            ->willReturn(
                '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><Accounts><Account><Name>John Smith</Name><Number>1234567</Number></Account></Accounts>'
            );
        $Response->method('getStatusCode')->willReturn(200);
    ...
    public function testGetSalesAccountsReturnsBlankArrayOnFail() {
        ...
        $this->assertSame([], $Reporter->getSalesAccounts());
    }
    ...
    public function testGetSalesVendorsReturnsCorrectArray() {
        ...
        $this->assertSame([1234567, 9876543], $Reporter->getSalesVendors());
    }
    ...
    public function testGetSalesVendorsReturnsBlankArrayOnFail() {
        ...
        $this->assertSame([], $Reporter->getSalesVendors());
    }
    ...
    public function testGetFinanceAccountsReturnsBlankArrayOnFail() {
        ...
        $this->assertSame([], $Reporter->getFinanceAccounts());
    }
    ...
    public function testGetFinanceVendorsReturnsCorrectArray() {
        ...
        $Response
            ->method('getBody')
            ->willReturn(
                '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><VendorsAndRegions><Vendor><Number>1234567</Number><Region><Code>AE</Code><Reports><Report>Financial</Report></Reports></Region><Region><Code>AU</Code><Reports><Report>Financial</Report><Report>Sale</Report></Reports></Region></Vendor></VendorsAndRegions>'
            );
        $Response->method('getStatusCode')->willReturn(200);
    ...
    public function testGetFinanceVendorsReturnsBlankArrayOnFail() {
        ...
        $this->assertSame([], $Reporter->getFinanceVendors());
    }
    ...
    public function testGetSalesReportReturnsCorrectReport() {
        ...
        $Response->method('getBody')->willReturn(new TestSalesReportContent());
        $Response->method('getStatusCode')->willReturn(200);
    ...
    public function testGetSalesReportReturnsBlankArrayWhenNoReport() {
        ...
        $Response
            ->method('getBody')
            ->willReturn(new TestSalesReportNoContent());
        $Response->method('getStatusCode')->willReturn(404);
    ...
    public function testGetLastResultReturnsCorrectValue() {
        ...
        $this->assertNull($Reporter->getLastResult());
