...
use Dlab\ITCReporter\Responses\SalesGetVendors;
...
class SalesGetVendorsTest extends \PHPUnit\Framework\TestCase {
    public function testProcessReturnsCorrectValueForSingleSalesVendor() {
        ...
        $Response
            ->method('getBody')
            ->willReturn(
                '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><Vendors><Vendor>1234567</Vendor></Vendors>'
            );

        $Processor = new SalesGetVendors($Response);

        $this->assertSame([1234567], $Processor->process());
    }
    ...
    public function testProcessReturnsCorrectValueForMultipleSalesVendor() {
        ...
        $this->assertSame([1234567, 9876543], $Processor->process());
    }
    ...
    public function testProcessReturnsEmptyArrayForInvalidXML() {
        ...
        $Response
            ->method('getBody')
            ->willReturn(
                '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><Vendors>1234567</Vendor><dor>9876543</Vendor></Vendors>'
            );
